...
export GPT_4O_MINI_AZURE_API_VERSION=2024-06-01
export GPT_4O_MINI_API_KEY=XXX
export GPT_4O_MINI_ENDPOINT=XXX

export WANDB_PROJECT="RL-Hammer"
export VLLM_WORKER_MULTIPROC_METHOD=spawn

LR=1e-5
RUN_NAME=rl_hammer_target_llama_3_1_8b_instruct_with_llm_judge_diversity_reward_lora
...
accelerate launch \
    ...
    --reward_functions InjecAgentToolCallingReward LLMJudgeDiversityReward \
